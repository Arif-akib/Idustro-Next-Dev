                ...
                <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-5 mt-5">
                        <div className="p-4 rounded primary-background text-white drop-shadow ">
                            ...
                            <p>
                                NIECO Nest, 2nd & 3rd Floor, 194 Central
                        ...
                        <div className="p-4 rounded primary-background text-white drop-shadow ">
                            ...
                            <p>
                                DDL Halima Garden, 72 Central Bashabo, Sabujbag,
                                4th Floor, Suite #4/A, Dhaka-1214, Bangladesh
                            </p>
                        </div>
                        <div className="p-4 rounded primary-background text-white drop-shadow ">
                            <h2 className="text-xl font-bold mb-1">
                                hittagong Regional Office
                            </h2>
                            <p>
                                Ambia Legun, Laky Valley Residential Area, Flat
                                No. A-2 (2nd Floor), Plot No. 6/7, Road No. 7,
                                Foy&apos;s Lake, Khulshi-4225, Chittagong.
                            </p>
                        </div>
                    </div>
                </div>
