...
import bg1 from "/public/images/service/post-5-150x150.jpg";
import bg2 from "/public/images/service/service-12-450x500.jpg";
import bg3 from "/public/images/service/service-2-450x500.jpg";
            ...
            <div className="py-32 bg-gray-100 px-[10%]">
                <div>
                    ...
                    <p className="text-gray-600 w-1/2 mx-auto text-center">
                        We are one of Europe’s largest technology and IT
                        consulting companies with over 33,000 employees in over
                        30 countries and collaborations with Europe’s.
                    </p>
                </div>
                <div className="pt-10 grid grid-cols-3 gap-8">
                    {contents.map((content, index) => (
                        <div
                            key={index}
                            className="p-5 rounded-md shadow-md bg-white group flex flex-col gap-4"
                        >
