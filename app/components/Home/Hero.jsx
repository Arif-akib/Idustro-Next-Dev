      ...
      <div className="">
        <div className="h-[990px] relative bg-black">
          ...
          <div className="absolute z-30 flex flex-col gap-5 right-5 top-[350px]">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="currentColor" className="text-xl group-hover:text-white duration-500"><path d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"></path></svg>
            </button>
            <button
              onClick={slideLeft}
              className="size-[50px] flex items-center justify-center bg-white rounded-3xl hover:bg-[#FA4318] group duration-500"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="currentColor" className="text-xl group-hover:text-white duration-500"><path d="M7.82843 10.9999H20V12.9999H7.82843L13.1924 18.3638L11.7782 19.778L4 11.9999L11.7782 4.22168L13.1924 5.63589L7.82843 10.9999Z"></path></svg>
            </button>
          </div>
