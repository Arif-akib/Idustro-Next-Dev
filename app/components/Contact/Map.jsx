export default function ContactMap() {
    return (
        <>
            <div className="px-[5%] xl:px-[10%] py-16 bg-[url('/src/assets/images/background/bg-bottom-portfolio-content.png')] bg-right bg-no-repeat">
                ...
                <div className="rounded-lg p-3 bg-white shadow-md h-[50vh] xl:h-[80vh]">
                    <iframe
