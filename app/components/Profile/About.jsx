            ...
            <div className="pt-32 pb-10 px-[10%] flex gap-5 bg-[url('/images/background/bg-bottom-portfolio-content.png')] bg-no-repeat bg-right">
                <div className="max-w-[350px]">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex items-center gap-5 font-bold text-lg mb-3">
                            <p className="size-[40px] bg-gray-100 primary-color flex items-center justify-center rounded-md">
