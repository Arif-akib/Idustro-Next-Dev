            ...
            <div className="relative top-0 z-50">
                <div className="relative">
                    ...
                    <div className="absolute w-[70%] bottom-[-50px] right-0">
                        <div className="bg-[#203b70] h-[85px] text-white flex items-center justify-between w-full pr-[15%] relative">
                            ...
                            <div className="h-0 w-0 border-[42.5px] border-transparent border-r-[#203b70] border-b-[#203b70] absolute translate-x-[-100%]"></div>
                        </div>
                    </div>
                </div>
            </div>
