...
export default function SkillStacts({ contents }) {
    return (
      <>
        <div className="bg-[url('/images/background/bg-progress-bar.jpg')] bg-center py-10 px-[10%] flex gap-10">
          <div className="w-1/2 -mb-20 rounded-md relative z-10 hidden md:block">
            <Image
              src={contents.img}
              alt=""
          ...
          <div className="md:w-1/2">
            ...
            <h2 className="text-3xl xl:text-5xl font-bold text-white py-3 pb-5">
              {contents.heading}
            </h2>
