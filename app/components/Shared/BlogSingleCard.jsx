    ...
    return (
        <>
            <div className="group relative h-[350px] w-full rounded-lg">
                ...
                />
                <p className="uppercase py-1.5 px-3 primary-background absolute z-10 rounded-sm text-white top-5 right-5 group-hover:-translate-y-5 group-hover:opacity-0 duration-300 ease-out">
                    {content.type}
                </p>
