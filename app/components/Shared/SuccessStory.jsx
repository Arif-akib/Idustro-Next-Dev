...
export default function SuccessStory({ story }) {
  return (
    <>
      <div className="px-[5%] xl:px-[10%] pb-32">
        <h1 className="text-5xl font-bold text-center">Our Success Story</h1>
        <div className="mt-10 md:flex items-center space-y-5">
          <div className="md:w-[calc(100%-300px)] h-[480px]">
            <Image
              src={story.img}
              alt=""
          ...
          <div className="rounded-md shadow-md bg-white md:w-[400px] relative z-10 md:ml-[-100px]">
