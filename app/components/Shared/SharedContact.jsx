export default function SharedContact() {
    return (
        <>
            <div className="bg-[url('/images/background/bg-banner-poster.jpg')] h-[300px] bg-center relative overflow-hidden rounded-md">
                ...
                <div className="size-full absolute z-10 flex justify-between gap-5 px-[5%]">
                    ...
                    <img src="/images/background/Image4.png" alt="" className="h-full"/>
                </div>
            </div>
        </>
    )
