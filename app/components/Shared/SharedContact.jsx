export default function SharedContact() {
    return (
        <>
            <div className="bg-[url('/images/background/bg-banner-poster.jpg')] h-[400px] lg:h-[300px] bg-center relative overflow-hidden rounded-md">
                ...
                <div className="size-full absolute z-10 flex flex-col lg:flex-row justify-center lg:justify-between items-center  gap-5 px-[5%]">
                    <div className="lg:w-1/2 flex flex-col gap-5 justify-center py-5">
                        <h2 className="text-white text-3xl lg:text-5xl font-semibold">Gets an Quotation For Your Industry</h2>
                    ...
                    <img src="/images/background/Image4.png" alt="" className="h-full hidden lg:block"/>
                </div>
            </div>
        </>
    )
