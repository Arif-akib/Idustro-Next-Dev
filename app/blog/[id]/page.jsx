...
export default function SingleBlog({ params }) {
    ...
    return (
        ...
        <>
            ...
            <div className="w-[1000px] mx-auto py-32">
                <Image src={blog.bg} className="w-full h-[450px] object-cover rounded-t-md"></Image>
                <div className=" px-10 border rounded-b-md space-y-5 py-5">
                <div className="flex items-center w-full gap-5 font-bold">
                <p className="text-white primary-background px-3 py-1.5 rounded-md text-sm font-bold">{blog.type}</p>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sed totam blanditiis praesentium, eveniet neque et eum doloremque incidunt possimus? Dignissimos. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rem earum labore, illum voluptate explicabo pariatur aperiam! Quam id delectus odit!</p>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Et qui at quam ipsam, fugiat blanditiis itaque, odio veniam molestiae, voluptate cupiditate ut explicabo amet? Quasi, vero! Repellat illum voluptates perspiciatis debitis, cupiditate eaque laboriosam pariatur aspernatur eligendi neque voluptate vel!</p>
                    <p className="bg-gray-100 p-5 rounded-md">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio, itaque?</p>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quod exercitationem mollitia voluptates iusto sapiente accusantium sit, a accusamus corrupti magnam magni, architecto optio dicta officiis molestiae at maiores nesciunt! Deleniti exercitationem quasi officiis modi quae nemo molestias libero tempora! Deserunt doloremque molestias aspernatur recusandae sapiente sit, voluptate hic iure ratione.</p>
                </div>
